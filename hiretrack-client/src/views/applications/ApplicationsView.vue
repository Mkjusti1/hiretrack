    ...
    <div v-if="showSchedule" class="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div class="bg-white rounded-xl p-6 w-full max-w-md shadow-xl">
        ...
        <form @submit.prevent="handleSchedule" class="space-y-3">
          ...
          <input v-model="scheduleForm.location" placeholder="Location / Video link (optional)" class="w-full border rounded-lg px-3 py-2 text-sm" />
          <textarea v-model="scheduleForm.notes" placeholder="Notes (optional)" class="w-full border rounded-lg px-3 py-2 text-sm" rows="2" />
          <div class="flex gap-3 pt-2">
    ...
    <div v-if="showFeedback" class="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div class="bg-white rounded-xl p-6 w-full max-w-md shadow-xl">
        ...
        <form @submit.prevent="handleFeedback" class="space-y-3">
          ...
          <textarea v-model="feedbackForm.feedbackNotes" placeholder="Feedback notes" required class="w-full border rounded-lg px-3 py-2 text-sm" rows="4" />
          <div class="flex gap-3 pt-2">
